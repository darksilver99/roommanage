...
Future<int> queryRoomListRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RoomListRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query BuildingListRecords (as a Stream and as a Future).
Future<int> queryBuildingListRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
...
Stream<List<BuildingListRecord>> queryBuildingListRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<BuildingListRecord>> queryBuildingListRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
/// Functions to query PaymentRoomListRecords (as a Stream and as a Future).
Future<int> queryPaymentRoomListRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<PaymentRoomListRecord>> queryPaymentRoomListRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PaymentRoomListRecord.collection,
      PaymentRoomListRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PaymentRoomListRecord>> queryPaymentRoomListRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
